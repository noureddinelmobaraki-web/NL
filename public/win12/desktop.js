...
function setIcon() {
    ...
    <div class="b" ondblclick="openapp('explorer'); setTimeout(() => apps.explorer.goto('C:/用户/Administrator/Music'), 300);" ontouchstart="openapp('explorer'); setTimeout(() => apps.explorer.goto('C:/用户/Administrator/Music'), 300);" oncontextmenu="return showcm(event,'desktop.icon',['explorer',-1]);" appname="explorer">
        <img src="icon/folder/music.svg">
        <p>NL Music Folder</p>
    </div>
...
function nupd() {
    ...
    (function injectNLPortfolio() {
        ...
        const nlSongs = [
            ...
            { name: "VETO", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/VETO/index.m3u8" },
            { name: "TOTAL", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/TOTAL/index.m3u8" },
            { name: "7CHAYCHI DIMO9RATI", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/7CHAYCHI.DIMO9RATI/index.m3u8" },
            { name: "A Lot", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/A.Lot/index.m3u8" },
            { name: "BEAUTIFUL", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/BEAUTIFUL/index.m3u8" },
            { name: "Bouh", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/Bouh/index.m3u8" },
            { name: "Brain Damage", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/Brain.Damage/index.m3u8" },
            { name: "Deal With The Devil", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/Deal.With.The.Devil/index.m3u8" },
            { name: "Dokhana V2", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/Dokhana.V2/index.m3u8" },
            { name: "GOUROU", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/GOUROU/index.m3u8" },
            { name: "ITCHY W SCRATCHY", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/ITCHY.W.SCRATCHY/index.m3u8" },
            { name: "KOUN NADI", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/KOUN.NADI/index.m3u8" },
            { name: "L'AI Could Never", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/L.AI.Could.Never/index.m3u8" },
            { name: "L'bayda Mon Amour", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/L.bayda.Mon.Amour/index.m3u8" },
            { name: "Let The Rhythm Hit 'em", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/Let.The.Rhythm.Hit.em/index.m3u8" },
            { name: "LMORPHINIYA 31", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/LMORPHINIYA.31/index.m3u8" },
            { name: "LMORPHINIYA 33", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/LMORPHINIYA.33/index.m3u8" },
            { name: "LMORPHINIYA 1013", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/LMORPHINIYA.1013/index.m3u8" },
            { name: "Lmorphinya 19 V2", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/Lmorphinya.19.V2/index.m3u8" },
            { name: "MAGNETO", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/MAGNETO/index.m3u8" },
            { name: "None Shall Pass", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/None.Shall.Pass/index.m3u8" },
            { name: "Ohio", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/Ohio/index.m3u8" },
            { name: "Ostora", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/Ostora/index.m3u8" },
            { name: "Tromso", url: "https://noureddinelmobaraki-web.github.io/nl-audio-cdn/Tromso/index.m3u8" }
        ];
        ...
        apps.nlmusic = {
            ...
            init: () => {
                try {
                    apps.nlmusic.initAudio();
                } catch(e) {
                    console.error("nlmusic init error:", e);
                }
            },
            load: () => {
                try {
                    ...
                    console.error("nlmusic load error:", e);
                }
            },
            initAudio: () => {
                try {
                    if (apps.nlmusic.audio) return;
                    apps.nlmusic.audio = document.getElementById('nl-audio-element');
                    if (!apps.nlmusic.audio) return;
                    
                    const listEl = document.getElementById('nl-music-playlist');
                    if (listEl) {
                        listEl.innerHTML = apps.nlmusic.songs.map((song, i) => `
                            <div class="nl-music-item" id="nl-song-item-${i}" onclick="apps.nlmusic.playSong(${i})">
                                <span class="track-num">${String(i + 1).padStart(2, '0')}</span>
                                <div class="song-info">
                                    <span class="song-title">${song.name}</span>
                                    <span class="song-artist">NL</span>
                                </div>
                            </div>
                        `).join('');
                    }

                    apps.nlmusic.audio.addEventListener('timeupdate', apps.nlmusic.onTimeUpdate);
                    apps.nlmusic.audio.addEventListener('ended', apps.nlmusic.nextSong);

                    const pbar = document.getElementById('nl-music-progress');
                    if (pbar) {
                        pbar.addEventListener('input', (e) => {
                            if (apps.nlmusic.audio && apps.nlmusic.audio.duration) {
                                apps.nlmusic.audio.currentTime = (e.target.value / 100) * apps.nlmusic.audio.duration;
                            }
                        });
                    }

                    const vbar = document.getElementById('nl-music-volume');
                    if (vbar) {
                        vbar.addEventListener('input', (e) => {
                            if (apps.nlmusic.audio) {
                                apps.nlmusic.audio.volume = e.target.value / 100;
                            }
                        });
                    }
                } catch(e) {
            ...
            playSong: (index) => {
                try {
                    apps.nlmusic.initAudio();
                    if (!apps.nlmusic.audio) return;
                    if (index < 0 || index >= apps.nlmusic.songs.length) return;
                    apps.nlmusic.currentSongIndex = index;
                    const song = apps.nlmusic.songs[index];

                    $('.nl-music-item').removeClass('playing');
                    $(`#nl-song-item-${index}`).addClass('playing');

                    const itemNode = $(`#nl-song-item-${index}`)[0];
                    if (itemNode) {
                    ...
                    if (typeof Hls !== 'undefined' && Hls.isSupported()) {
                        if (apps.nlmusic.hls) {
                            apps.nlmusic.hls.destroy();
                        }
                        const hls = new Hls();
                        apps.nlmusic.hls = hls;
                        hls.loadSource(src);
                        hls.attachMedia(apps.nlmusic.audio);
                        hls.on(Hls.Events.MANIFEST_PARSED, function() {
                            apps.nlmusic.audio.play().catch(err => console.log("Play failed, click play to start", err));
                            apps.nlmusic.setPlayingState(true);
                        });
                    } else if (apps.nlmusic.audio.canPlayType('application/vnd.apple.mpegurl')) {
                        apps.nlmusic.audio.src = src;
                        apps.nlmusic.audio.play().catch(err => console.log("Play failed, click play to start", err));
                        apps.nlmusic.setPlayingState(true);
                    } else {
                        apps.nlmusic.audio.src = src;
            ...
            togglePlay: () => {
                try {
                    apps.nlmusic.initAudio();
                    if (!apps.nlmusic.audio) return;
                    if (apps.nlmusic.isPlaying) {
                        apps.nlmusic.audio.pause();
                        apps.nlmusic.setPlayingState(false);
                    } else {
                        if (apps.nlmusic.audio.src || (apps.nlmusic.hls && apps.nlmusic.hls.url)) {
                            apps.nlmusic.audio.play().catch(err => console.log("Play failed, click play to start", err));
                            apps.nlmusic.setPlayingState(true);
                        } else {
                            apps.nlmusic.playSong(0);
                        }
                    }
                } catch(e) {
            ...
            setPlayingState: (playing) => {
                apps.nlmusic.isPlaying = playing;
                const btn = document.getElementById('nl-music-play-btn');
                const disc = document.getElementById('nl-music-vinyl');
                if (playing) {
            ...
            nextSong: () => {
                ...
                apps.nlmusic.playSong(nextIdx);
            },
            prevSong: () => {
                let prevIdx = (apps.nlmusic.currentSongIndex - 1 + apps.nlmusic.songs.length) % apps.nlmusic.songs.length;
                apps.nlmusic.playSong(prevIdx);
            },
            onTimeUpdate: () => {
                const cur = apps.nlmusic.audio.currentTime;
                const dur = apps.nlmusic.audio.duration || 0;
                const progress = dur > 0 ? (cur / dur) * 100 : 0;

                const pbar = document.getElementById('nl-music-progress');
                if (pbar) pbar.value = progress;

                const tcurr = document.getElementById('nl-music-time-curr');
                if (tcurr) tcurr.innerText = apps.nlmusic.formatTime(cur);

                const ttotal = document.getElementById('nl-music-time-total');
                if (ttotal) ttotal.innerText = dur > 0 ? apps.nlmusic.formatTime(dur) : '00:00';
            },
            formatTime: (sec) => {
        ...
        apps.nlphotos = {
            ...
            initGallery: () => {
                try {
                    apps.nlphotos.openFolder(apps.nlphotos.currentFolder, apps.nlphotos.currentIndex);
                } catch(e) {
                    console.error("initGallery error:", e);
                }
            },
            openFolder: (folderName, index = 0) => {
                try {
                    ...
                    const thumbsContainer = document.getElementById('nl-photo-thumbnails');
                    if (thumbsContainer) {
                        const imgs = apps.nlphotos.folders[folderName];
                        if (imgs) {
                            thumbsContainer.innerHTML = imgs.map((imgUrl, idx) => `
                                <div class="nl-thumb-item ${idx === index ? 'active' : ''}" onclick="apps.nlphotos.openImage('${folderName}', ${idx})">
                    ...
                    apps.nlphotos.showImage();
                } catch(e) {
                    console.error("openFolder error:", e);
                }
            },
            openImage: (folderName, index) => {
                try {
                    apps.nlphotos.openFolder(folderName, index);
                } catch(e) {
            ...
            nextImage: () => {
                try {
                    const list = apps.nlphotos.folders[apps.nlphotos.currentFolder];
                    if (list && list.length > 0) {
                        let nextIndex = (apps.nlphotos.currentIndex + 1) % list.length;
                        apps.nlphotos.openImage(apps.nlphotos.currentFolder, nextIndex);
                    }
                } catch(e) {
            ...
            prevImage: () => {
                try {
                    const list = apps.nlphotos.folders[apps.nlphotos.currentFolder];
                    if (list && list.length > 0) {
                        let prevIndex = (apps.nlphotos.currentIndex - 1 + list.length) % list.length;
                        apps.nlphotos.openImage(apps.nlphotos.currentFolder, prevIndex);
                    }
                } catch(e) {
...
if (document.readyState === 'complete' || document.readyState === 'interactive') {
    ...
    document.getElementsByTagName('body')[0].onload = nupd;
}
