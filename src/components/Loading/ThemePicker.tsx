...
const ICON: Record<Theme, JSX.Element> = {
  ...
  dark: (
    ...
    >
      <path
        d="M21 12.8A8 8 0 1 1 11.2 3 6.2 6.2 0 0 0 21 12.8Z"
        fill="currentColor"
      />
    </svg>
  ),
...
const THEMES: ThemeDef[] = [
  {
    id: "midnight",
    label: "Home",
    bg: "radial-gradient(circle at 30% 30%, #2a2160, #15103a)",
    fg: "#cdb4ff",
    radius: "50% 50% 52% 48% / 55% 50% 50% 45%",
    icon: ICON.midnight,
  },
  {
    id: "dark",
    label: "Dark",
    bg: "radial-gradient(circle at 30% 30%, #2b2b2b, #0e0e0e)",
    fg: "#ffffff",
    radius: "54% 46% 50% 50% / 48% 52% 48% 52%",
    icon: ICON.dark,
  },
  {
    id: "light",
    label: "Light",
    bg: "radial-gradient(circle at 30% 30%, #ffffff, #ece4d6)",
    fg: "#2a2a2a",
    radius: "48% 52% 46% 54% / 52% 46% 54% 48%",
    icon: ICON.light,
  },
  {
    id: "bit",
    label: "8-Bit",
    bg: "radial-gradient(circle at 30% 30%, #29469e, #1d2b53)",
    fg: "#ffd166",
    radius: "50% 50% 48% 52% / 50% 54% 46% 50%",
    icon: ICON.bit,
  },
  {
    id: "lite",
    label: "Lite",
    bg: "radial-gradient(circle at 30% 30%, #3c5a45, #233528)",
    fg: "#d7ffe0",
    radius: "52% 48% 54% 46% / 46% 50% 50% 54%",
    icon: ICON.lite,
  },
  {
    id: "retro",
    label: "Retro",
    bg: "radial-gradient(circle at 30% 30%, #dfb56c, #8c6018)",
    fg: "#121212",
    radius: "45% 55% 48% 52% / 52% 48% 52% 48%",
    icon: ICON.retro,
  },
];
    ...
    {THEMES.map((t) => (
      <button
        ...
        style={{
          ...
          transition:
            "transform 0.25s ease, filter 0.25s ease, box-shadow 0.25s ease",
        }}
        onMouseEnter={(e) => {
